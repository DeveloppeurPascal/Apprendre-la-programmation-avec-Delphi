object DataModule2: TDataModule2
  ...
  object tabAuteursDUnLivre: TFDQuery
    OnCalcFields = tabAuteursDUnLivreCalcFields
    Connection = FDConnection1
    SQL.Strings = (
      'select'
      #9'auteurs.*'
      ...
      #9'livres.id=:livre'
      'order by'
      #9'auteurs.nom,auteurs.prenom,auteurs.pseudo')
    Left = 72
    Top = 120
    ParamData = <
      item
    ...
    object tabAuteursDUnLivreNomPrenomOuPseudo: TStringField
      FieldKind = fkCalculated
      FieldName = 'NomPrenomOuPseudo'
      Calculated = True
    end
    object tabAuteursDUnLivrenom: TStringField
      FieldName = 'nom'
      Origin = 'nom'
      Size = 255
    end
    object tabAuteursDUnLivreprenom: TStringField
      FieldName = 'prenom'
      Origin = 'prenom'
      Size = 255
    end
    object tabAuteursDUnLivrepseudo: TStringField
      FieldName = 'pseudo'
      Origin = 'pseudo'
      Size = 255
    end
    object tabAuteursDUnLivreid: TFDAutoIncField
      FieldName = 'id'
      Origin = 'id'
      ProviderFlags = [pfInWhere, pfInKey]
    end
